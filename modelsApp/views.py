...
from .models import Customer, Product, Contact, Project, Reader, Seller, Task, Book, Sale
from .forms import ContactForm, CustomerForm, ProductForm, ProductUpdateForm, SaleForm, SellerForm
